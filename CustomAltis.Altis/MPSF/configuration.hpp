...
class CfgMissionFramework {
	...
	AdminUIDs[] = {
		...
		,"76561198094297832"	/* example Player UID "getPlayerUID" */
		,"76561198349784399"	/* example Player UID "getPlayerUID" */
		,"76561198088661268"	/* example Player UID "getPlayerUID" */
		,"76561198057119793"	/* example Player UID "getPlayerUID" */	
		,"76561198080083066"	/* example Player UID "getPlayerUID" */	
		,"76561198343729269"	/* example Player UID "getPlayerUID" */		
	};
	// Task Objects
